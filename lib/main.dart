...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // METHOD
  Future<void> doXendit() async {
    setState(() {
      isLoading = true;
    });
    var xen_key_test = "YOUR_XENDIT_KEY";
    ...
    printWrapped(json.encode(res));

    var dataResponse = json.encode(res);

    setState(() {
      isLoading = false;
      urlPayment = res['invoice_url'].toString();
    });
    ...
    // PayoutResponse payoutResponse = await xendit.createPayout(
    //     external_id: "external_id", amount: 10000, email: "hai@gmail.com");
